...
import org.cli.collect.android.openrosa.OpenRosaConstants;
...
import org.cli.collect.android.test.MockedServerTest;
...
import static org.cli.collect.android.test.TestUtils.assertMatches;
import static org.cli.collect.android.test.TestUtils.cleanUpTempFiles;
import static org.cli.collect.android.test.TestUtils.createTempFile;
import static org.cli.collect.android.test.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTaskTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("org.cli.collect.android/.* Dalvik/.*", r.getHeader("User-Agent"));
