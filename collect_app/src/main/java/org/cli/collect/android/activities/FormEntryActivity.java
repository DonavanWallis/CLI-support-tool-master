...
package org.cli.collect.android.activities;
...
import org.cli.collect.android.audio.AudioControllerView;
import org.cli.collect.android.dao.FormsDao;
import org.cli.collect.android.dao.helpers.ContentResolverHelper;
import org.cli.collect.android.dao.helpers.FormsDaoHelper;
import org.cli.collect.android.dao.helpers.InstancesDaoHelper;
import org.cli.collect.android.events.ReadPhoneStatePermissionRxEvent;
import org.cli.collect.android.events.RxEventBus;
import org.cli.collect.android.exception.JavaRosaException;
import org.cli.collect.android.external.ExternalDataManager;
import org.cli.collect.android.formentry.FormLoadingDialogFragment;
import org.cli.collect.android.formentry.ODKView;
import org.cli.collect.android.formentry.QuitFormDialog;
import org.cli.collect.android.formentry.SaveFormProgressDialogFragment;
import org.cli.collect.android.formentry.audit.AuditEvent;
import org.cli.collect.android.formentry.audit.AuditUtils;
import org.cli.collect.android.formentry.audit.ChangesReasonPromptDialogFragment;
import org.cli.collect.android.formentry.audit.IdentifyUserPromptDialogFragment;
import org.cli.collect.android.formentry.audit.IdentityPromptViewModel;
import org.cli.collect.android.formentry.backgroundlocation.BackgroundLocationHelper;
import org.cli.collect.android.formentry.backgroundlocation.BackgroundLocationManager;
import org.cli.collect.android.formentry.backgroundlocation.BackgroundLocationViewModel;
import org.cli.collect.android.formentry.repeats.AddRepeatDialog;
import org.cli.collect.android.formentry.saving.FormSaveViewModel;
import org.cli.collect.android.fragments.MediaLoadingFragment;
import org.cli.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.cli.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import org.cli.collect.android.fragments.dialogs.NumberPickerDialog;
import org.cli.collect.android.fragments.dialogs.ProgressDialogFragment;
import org.cli.collect.android.fragments.dialogs.RankingWidgetDialog;
import org.cli.collect.android.listeners.AdvanceToNextListener;
import org.cli.collect.android.listeners.FormLoaderListener;
import org.cli.collect.android.listeners.PermissionListener;
import org.cli.collect.android.listeners.SavePointListener;
import org.cli.collect.android.listeners.WidgetValueChangedListener;
import org.cli.collect.android.location.client.GoogleLocationClient;
import org.cli.collect.android.logic.FormController;
import org.cli.collect.android.logic.FormController.FailedConstraint;
import org.cli.collect.android.logic.FormInfo;
import org.cli.collect.android.logic.ImmutableDisplayableQuestion;
import org.cli.collect.android.preferences.AdminKeys;
import org.cli.collect.android.preferences.AdminSharedPreferences;
import org.cli.collect.android.preferences.GeneralKeys;
import org.cli.collect.android.preferences.GeneralSharedPreferences;
import org.cli.collect.android.preferences.PreferencesActivity;
import org.cli.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.cli.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.cli.collect.android.storage.StorageInitializer;
import org.cli.collect.android.storage.StoragePathProvider;
import org.cli.collect.android.storage.StorageSubdirectory;
import org.cli.collect.android.tasks.FormLoaderTask;
import org.cli.collect.android.tasks.SaveFormIndexTask;
import org.cli.collect.android.tasks.SaveFormToDisk;
import org.cli.collect.android.tasks.SavePointTask;
import org.cli.collect.android.upload.AutoSendWorker;
import org.cli.collect.android.utilities.ApplicationConstants;
import org.cli.collect.android.utilities.DestroyableLifecyleOwner;
import org.cli.collect.android.utilities.DialogUtils;
import org.cli.collect.android.utilities.FileUtils;
import org.cli.collect.android.utilities.FormNameUtils;
import org.cli.collect.android.utilities.ImageConverter;
import org.cli.collect.android.utilities.MediaManager;
...
import org.cli.collect.android.utilities.SnackbarUtils;
import org.cli.collect.android.utilities.SoftKeyboardUtils;
import org.cli.collect.android.utilities.ToastUtils;
import org.cli.collect.android.widgets.DateTimeWidget;
import org.cli.collect.android.widgets.QuestionWidget;
import org.cli.collect.android.widgets.RangeWidget;
import org.cli.collect.android.widgets.StringWidget;
...
import static org.cli.collect.android.analytics.AnalyticsEvents.LAUNCH_FORM_WITH_BG_LOCATION;
import static org.cli.collect.android.analytics.AnalyticsEvents.SAVE_INCOMPLETE;
import static org.cli.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.cli.collect.android.preferences.GeneralKeys.KEY_BACKGROUND_LOCATION;
import static org.cli.collect.android.utilities.AnimationUtils.areAnimationsEnabled;
import static org.cli.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.cli.collect.android.utilities.PermissionUtils.areStoragePermissionsGranted;
import static org.cli.collect.android.utilities.PermissionUtils.finishAllActivities;
import static org.cli.collect.android.utilities.ToastUtils.showLongToast;
import static org.cli.collect.android.utilities.ToastUtils.showShortToast;
