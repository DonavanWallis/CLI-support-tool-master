...
package org.cli.collect.android.application;
...
import org.cli.collect.android.injection.config.AppDependencyComponent;
import org.cli.collect.android.injection.config.DaggerAppDependencyComponent;
...
import org.cli.collect.android.preferences.AutoSendPreferenceMigrator;
import org.cli.collect.android.preferences.FormMetadataMigrator;
...
import org.cli.collect.android.preferences.PrefMigrator;
...
import org.cli.collect.android.utilities.LocaleHelper;
import org.cli.collect.android.utilities.NotificationUtils;
...
import static org.cli.collect.android.logic.PropertyManager.PROPMGR_USERNAME;
import static org.cli.collect.android.logic.PropertyManager.SCHEME_USERNAME;
import static org.cli.collect.android.preferences.GeneralKeys.KEY_APP_LANGUAGE;
import static org.cli.collect.android.preferences.GeneralKeys.KEY_FONT_SIZE;
import static org.cli.collect.android.preferences.GeneralKeys.KEY_USERNAME;
import static org.cli.collect.android.tasks.sms.SmsNotificationReceiver.SMS_NOTIFICATION_ACTION;
import static org.cli.collect.android.tasks.sms.SmsSender.SMS_SEND_ACTION;
...
public class Collect extends Application {
     ...
     * and application version name: {@code Dalvik/<version> (platform info) org.cli.collect.android/v<version>}.
     *
    ...
    */
    ...
    private void setupRemoteAnalytics() {
        ...
        boolean isAnalyticsEnabled = settings.getBoolean(GeneralKeys.KEY_ANALYTICS, false);
        settings.edit().putBoolean("KEY_ANALYTICS", false).apply();
